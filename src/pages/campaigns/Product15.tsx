...
const Product15 = () => {
  ...
  const handleEnter = () => {
    // Navigate to Eye St website
    window.open('https://eyest.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">EYE ST</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">Free designer sunglasses with any designer frames purchase</h1>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/EYE_ST.jpg" 
                alt="Free designer sunglasses with any designer frames purchase" 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                Eye St's unparalleled collection offers so many choices, you'll want a different pair of glasses for every day. Just during May and June, Eye St is offering a free pair of designer sunglasses with every designer frames purchase.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Click <span className="font-bold">CLAIM</span> to book your exclusive frames consultation now.
              </p>
            </div>
