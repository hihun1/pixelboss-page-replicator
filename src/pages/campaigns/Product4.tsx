...
const Product4 = () => {
  ...
  const handleEnter = () => {
    // Navigate to Rina's Cucina website
    window.open('https://www.rinascucina.com.au', '_blank');
  };
      ...
      <main className="flex-grow">
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">Win a set menu and accompanying drinks experience for you and three friends.</h1>
