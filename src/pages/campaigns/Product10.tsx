...
const Product10 = () => {
  ...
  const handleEnter = () => {
    // Navigate to Paragon Studio website
    window.open('https://www.paragonstudio.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">Paragon Studio</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">A year of haircare from Paragon Studio could be yours.</h1>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/PARAGON_STUDIO.jpg" 
                alt="A year of haircare from Paragon Studio could be yours." 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                Win a year of cuts and styling from Paragon Studio, a barbershop on the cutting edge of men's aesthetics.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Click <span className="font-bold">CLAIM</span> to book your exclusive haircare experience now.
              </p>
            </div>
