...
const Product6 = () => {
  ...
  const handleEnter = () => {
    // Navigate to James Said website
    window.open('https://www.jamessaid.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">James Said</span>
            </div>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/jamessaid.png" 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                Experience the transformative power of our IPL Limelight treatments with this exclusive offer. Purchase 9 treatments and receive 3 additional sessions for free!
              </p>
              <p className="text-lg leading-relaxed mb-6">
