...
const Product16 = () => {
  ...
  const handleEnter = () => {
    // Navigate to Window Workshop website
    window.open('https://windowworkshop.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">WINDOW WORKSHOP</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">2025 Makeover - Win a consultation for your house</h1>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/WINDOW-WORKSHOP.jpg" 
                alt="2025 Makeover - Win a consultation for your house" 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                With bespoke solutions and a focus ranging from traditional to trends, a Window Workshop consultation will elevate your interior design. Win a consultation for your house, including indepth analysis, colour palettes and fabric swatching to plan your ideal home. Click ENTER to win your consultation.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Click <span className="font-bold">CLAIM</span> to book your exclusive consultation now.
              </p>
            </div>
