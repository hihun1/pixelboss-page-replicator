...
const Product7 = () => {
  ...
  const handleEnter = () => {
    // Navigate to Riva Bridal website
    window.open('https://www.rivabridal.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">Riva Bridal</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">Enjoy a high tea while you find your dream dress!</h1>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/0822b425fe42549f08a5473924486ece.jpg" 
                alt="Enjoy a high tea while you find your dream dress!" 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                Make your bridal dress shopping experience even more special with our complimentary high tea service. Enjoy delicate pastries and fine teas while you explore our latest bridal collection.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Click <span className="font-bold">CLAIM</span> to book your exclusive bridal appointment now.
              </p>
            </div>
