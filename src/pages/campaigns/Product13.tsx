...
const Product13 = () => {
  ...
  const handleEnter = () => {
    // Navigate to Amaru website
    window.open('https://amarumelbourne.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">AMARU</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">Win an Amaru Sensory Menu experience for two</h1>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/AMARU.jpg" 
                alt="Win an Amaru Sensory Menu experience for two" 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                A small intimate dining room in Armadale offering Contemporary Australian Cuisine, Amaru offers a tasting menu inspired by exquisite Australian produce. Win an Amaru Sensory Menu dining experience for two. Click ENTER to book your exclusive dining experience now.
              </p>
              <p className="text-lg leading-relaxed mb-6">
