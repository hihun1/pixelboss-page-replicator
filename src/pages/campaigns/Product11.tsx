...
const Product11 = () => {
  ...
  const handleEnter = () => {
    // Navigate to Facial Healing Co website
    window.open('https://www.facialhealingco.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">FACIAL HEALING CO</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">Claim luminous skin with a bespoke facial regimen plan.</h1>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/FACIAL_HEALING_CO.jpg" 
                alt="Claim luminous skin with a bespoke facial regimen plan." 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                Nourish your skin and restore your energy with a holistic facial treatment designed to promote balance and overall wellbeing. Holly will analyse your skin and develop a regimen bespoke to your skin's needs, usually valued at $200.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Click <span className="font-bold">CLAIM</span> to book your exclusive facial consultation now.
              </p>
            </div>
