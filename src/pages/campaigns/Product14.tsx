...
const Product14 = () => {
  ...
  const handleEnter = () => {
    // Navigate to DOTF website
    window.open('https://dotf.com.au', '_blank');
  };
        ...
        <div className="bg-white min-h-screen pt-16">
          <div className="mx-auto px-4 sm:px-6 max-w-[1040px]">
            <div className="mb-4 flex items-center">
              ...
              <span className="uppercase font-medium">DOTF</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold mb-6">Boost your engagement with a content plan from Department of the Future</h1>
            ...
            <div className="mb-10">
              <img 
                src="https://wp.hmm.pixelboss.io/wp-content/uploads/2025/04/DOTF.png" 
                alt="Boost your engagement with a content plan from Department of the Future" 
            ...
            <div className="mb-10">
              <p className="text-lg leading-relaxed mb-6">
                DOTF is offering a limited number of consultations for small businesses and brands looking to grow their engagement. An Engagement Agency with over 15 years experience, and clients ranging from the local, such as City of Stonnington, to the international, such as Mastercard, their engagement specialists will create a plan bespoke to your needs. Click CLAIM to book your consultation now.
              </p>
              <p className="text-lg leading-relaxed mb-6">
                Click <span className="font-bold">CLAIM</span> to book your consultation now.
              </p>
            </div>
